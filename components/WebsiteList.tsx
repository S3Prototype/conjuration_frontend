...
function WebsiteList() {
    return (        
        <section id="website_portfolio" className={listStyles.portfolio_section}>
                ...
                <FeaturedProject
                    projectName="Adrian Goldsworthy"
                    image="https://res.cloudinary.com/diujqlncs/image/upload/v1618245716/conjuration_frontent/adrian_hx1ewl.png"
                    url="https://mystifying-heyrovsky-571bbb.netlify.app/"
                />
